...
{
  "MetaTrader": {
    "server": "سرور_MT5_شما_اینجا",        // سرور MetaTrader 5 شما
    "username": 12345678,                    // شماره حساب MT5 شما
    "password": "رمز_عبور_MT5_شما",         // رمز عبور MT5 شما
    "path": "C:\\Program Files\\MetaTrader 5\\terminal64.exe"
  },
  "Telegram": {
    "api_id": 12345678,                      // شناسه API تلگرام شما
    "api_hash": "هش_API_تلگرام_شما",        // هش API تلگرام شما
    "channels": {
      "whiteList": ["@نام_کاربری_کانال_شما"] // کانال‌های تلگرام برای نظارت
    }
  },
  "Notification": {
    "token": "توکن_ربات_تلگرام_شما",       // ربات تلگرام برای اعلان‌ها
    "chatId": 123456789                      // شناسه چت برای اعلان‌ها
  }
}
```
...
TelegramTrader از روش‌های پیکربندی متعدد برای حداکثر انعطاف پشتیبانی می‌کند:
